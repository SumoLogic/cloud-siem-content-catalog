# [Mappings](README.md): CloudTrail - cloudtrail.amazonaws.com - UpdateTrail
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-UpdateTrail`|
...
|description|None|The static text `An attempt to update a Trail in CloudTrail was requested` is populated in this schema field.|
