...
|timestamp|SCORData.SCORSoftware.SCORInventory.GMTTime|We expect the original record value of `SCORData.SCORSoftware.SCORInventory.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
