# [Mappings](README.md): Claude - platform_service_account_archived
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_service_account_archived`|
...
|action|type||
|changeTarget|service_account_id||
...
|description|None|The static text `Platform service account was archived` is populated in this schema field.|
