...
|timestamp|UpdateEvents.McAfeeCommonUpdater.UpdateEvent.GMTTime|We expect the original record value of `UpdateEvents.McAfeeCommonUpdater.UpdateEvent.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
