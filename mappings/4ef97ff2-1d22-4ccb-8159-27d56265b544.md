# [Mappings](README.md): CloudTrail - iam.amazonaws.com - CreateUser
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-CreateUser`|
...
|description|None|The static text `A request was made to create a new AWS IAM user` is populated in this schema field.|
