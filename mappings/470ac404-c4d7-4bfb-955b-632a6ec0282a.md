# [Mappings](README.md): Claude - claude_user_settings_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_user_settings_updated`|
...
|action|type||
|changeType|None|The static text `User settings in Claude were updated` is populated in this schema field.|
...
|description|None|The static text `User settings in Claude were updated` is populated in this schema field.|
