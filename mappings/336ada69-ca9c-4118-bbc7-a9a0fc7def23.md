# [Mappings](README.md): Claude - org_sso_connection_deactivated
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_sso_connection_deactivated`|
...
|changeType|None|The static text `SSO connection was deactivated - may bypass SSO controls` is populated in this schema field.|
...
|description|None|The static text `SSO connection was deactivated - may bypass SSO controls` is populated in this schema field.|
