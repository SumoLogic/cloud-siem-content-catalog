# [Mappings](README.md): CloudTrail - iam.amazonaws.com - AttachUserPolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-AttachUserPolicy`|
...
|description|None|The static text `An IAM policy was attached to a IAM user.` is populated in this schema field.|
