# [Mappings](README.md): Claude - platform_federation_issuer_archived
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_federation_issuer_archived`|
...
|description|None|The static text `OIDC federation issuer was archived` is populated in this schema field.|
