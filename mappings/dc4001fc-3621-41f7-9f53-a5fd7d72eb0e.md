# [Mappings](README.md): Claude - platform_service_account_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_service_account_updated`|
...
|description|None|The static text `Platform service account was updated` is populated in this schema field.|
