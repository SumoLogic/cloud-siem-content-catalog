# [Mappings](README.md): Claude - org_cowork_disabled
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_cowork_disabled`|
...
|action|type||
|changeType|None|The static text `Organization coworking feature was disabled` is populated in this schema field.|
...
|description|None|The static text `Organization coworking feature was disabled` is populated in this schema field.|
