# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DeleteUserPermissionsBoundary
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteUserPermissionsBoundary`|
...
|description|None|The static text `A request was made to remove the permissions boundary for a user.` is populated in this schema field.|
