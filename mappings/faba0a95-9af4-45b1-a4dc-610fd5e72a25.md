...
|timestamp|DLPAGENT11400.EventList.Event.GMTTime|We expect the original record value of `DLPAGENT11400.EventList.Event.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
