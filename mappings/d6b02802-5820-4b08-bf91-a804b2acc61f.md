# [Mappings](README.md): Claude - claude_file_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_file_deleted`|
...
|changeType|None|The static text `File in Claude was deleted` is populated in this schema field.|
...
|description|None|The static text `File in Claude was deleted` is populated in this schema field.|
