# [Mappings](README.md): Claude - org_user_invite_accepted
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_user_invite_accepted`|
...
|action|type||
|changeType|None|The static text `User accepted organization invitation` is populated in this schema field.|
...
|description|None|The static text `User accepted organization invitation` is populated in this schema field.|
