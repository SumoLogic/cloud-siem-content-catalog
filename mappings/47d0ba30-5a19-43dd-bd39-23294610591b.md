# [Mappings](README.md): Claude - mcp_server_created
...
|Log Format|JSON|
|Event ID Regex Pattern|`mcp_server_created`|
...
|changeType|None|The static text `MCP server was created` is populated in this schema field.|
...
|description|None|The static text `MCP server was created` is populated in this schema field.|
