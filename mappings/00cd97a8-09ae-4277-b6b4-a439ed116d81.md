# [Mappings](README.md): Claude - account_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`account_deleted`|
...
|description|None|The static text `User-initiated self-service account deletion` is populated in this schema field.|
