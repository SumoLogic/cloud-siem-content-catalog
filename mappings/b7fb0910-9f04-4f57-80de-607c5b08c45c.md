# [Mappings](README.md): Claude - platform_file_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_file_deleted`|
...
|changeType|None|The static text `File was deleted from platform workspace` is populated in this schema field.|
...
|description|None|The static text `File was deleted from platform workspace` is populated in this schema field.|
