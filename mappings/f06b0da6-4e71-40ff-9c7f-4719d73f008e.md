# [Mappings](README.md): Claude - claude_file_uploaded
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_file_uploaded`|
...
|action|type||
|changeTarget|claude_file_id||
|changeType|None|The static text `File was uploaded to Claude` is populated in this schema field.|
...
|description|None|The static text `File was uploaded to Claude` is populated in this schema field.|
|device_ip|actor.ip_address||
|file_basename|filename||
|file_uid|claude_file_id||
