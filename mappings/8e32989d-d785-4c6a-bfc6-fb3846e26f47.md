# [Mappings](README.md): CloudTrail - s3.amazonaws.com - PutBucketReplication
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-PutBucketReplication`|
...
|description|None|The static text `A request was made to create an S3 bucket replication configuration` is populated in this schema field.|
