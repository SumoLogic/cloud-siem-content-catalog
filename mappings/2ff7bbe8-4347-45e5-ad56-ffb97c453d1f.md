# [Mappings](README.md): Claude - desktop_extension_allowlisted
...
|Log Format|JSON|
|Event ID Regex Pattern|`desktop_extension_allowlisted`|
...
|description|None|The static text `Desktop extension was added to organization allowlist` is populated in this schema field.|
