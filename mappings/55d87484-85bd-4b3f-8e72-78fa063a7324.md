# [Mappings](README.md): Claude - platform_federation_rule_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_federation_rule_updated`|
...
|description|None|The static text `OIDC federation rule was updated` is populated in this schema field.|
