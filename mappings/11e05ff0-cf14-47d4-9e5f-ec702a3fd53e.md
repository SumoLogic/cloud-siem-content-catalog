# [Mappings](README.md): Netskope - DLP Alerts
...
|Log Format|JSON|
|Event ID Regex Pattern|`dlp-alert`|
...
|normalizedSeverity|dlp_rule_severity|This is a lookup field. More info to come in the catalog later...|
|severity|dlp_rule_severity|This is a lookup field. More info to come in the catalog later...|
|srcDevice_ip|srcip||
