...
|timestamp|TaskStatusEvent.ScannerSoftware.TaskStatusInfo.GMTTime|We expect the original record value of `TaskStatusEvent.ScannerSoftware.TaskStatusInfo.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
