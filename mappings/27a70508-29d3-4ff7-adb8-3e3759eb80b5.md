# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DeleteGroupPolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteGroupPolicy`|
...
|description|None|The static text `An IAM inline policy that is embedded in the specified IAM group was deleted.` is populated in this schema field.|
