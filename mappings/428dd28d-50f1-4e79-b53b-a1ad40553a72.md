# [Mappings](README.md): Claude - claude_project_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_project_deleted`|
...
|changeType|None|The static text `Claude project was deleted` is populated in this schema field.|
...
|description|None|The static text `Claude project was deleted` is populated in this schema field.|
