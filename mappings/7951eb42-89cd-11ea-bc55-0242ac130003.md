...
|timestamp|MSMERoot.MSME.MSMEEvent.GMTTime|We expect the original record value of `MSMERoot.MSME.MSMEEvent.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
