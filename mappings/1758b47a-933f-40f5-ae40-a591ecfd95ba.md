# [Mappings](README.md): CloudTrail - lambda.amazonaws.com - DeleteEventSourceMapping|DeleteFunction
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-(DeleteEventSourceMapping\|DeleteFunction)`|
