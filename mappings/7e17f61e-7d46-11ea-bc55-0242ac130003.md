# [Mappings](README.md): Endgame Protect JSON Catch All
...
|timestamp|created_at|We expect the original record value of `created_at` is in the format `yyyy-MM-dd'T'HH:mm:ssZ`|
