# [Mappings](README.md): Claude - desktop_extension_unblocked
...
|Log Format|JSON|
|Event ID Regex Pattern|`desktop_extension_unblocked`|
...
|description|None|The static text `Desktop extension was removed from global blocklist` is populated in this schema field.|
