...
|http_userAgent|ExtendedProperties_UserAgent||
|logonType|RecordTypeString||
|normalizedAction|Operation|This is a lookup field. More info to come in the catalog later...|
|normalizedCause|LogonError|This is a lookup field. More info to come in the catalog later...|
