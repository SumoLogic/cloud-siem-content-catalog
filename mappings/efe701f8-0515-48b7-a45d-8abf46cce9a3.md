# [Mappings](README.md): Claude - platform_federation_rule_archived
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_federation_rule_archived`|
...
|action|type||
|changeTarget|federation_rule_id||
...
|description|None|The static text `OIDC federation rule was archived` is populated in this schema field.|
