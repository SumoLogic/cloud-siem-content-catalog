# [Mappings](README.md): Claude - claude_code_review_repository_added
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_code_review_repository_added`|
...
|description|None|The static text `Repository was added to Claude Code Review configuration` is populated in this schema field.|
