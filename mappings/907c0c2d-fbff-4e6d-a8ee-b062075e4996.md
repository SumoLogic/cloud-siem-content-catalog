# [Mappings](README.md): Claude - tunnel_token_minted
...
|Log Format|JSON|
|Event ID Regex Pattern|`tunnel_token_minted`|
...
|description|None|The static text `OAuth token for MCP tunnel management was minted` is populated in this schema field.|
