# [Mappings](README.md): Claude - role_assignment_granted
...
|Log Format|JSON|
|Event ID Regex Pattern|`role_assignment_granted`|
...
|action|type||
|changeTarget|role||
|changeType|None|The static text `Role assignment was granted` is populated in this schema field.|
...
|description|None|The static text `Role assignment was granted` is populated in this schema field.|
