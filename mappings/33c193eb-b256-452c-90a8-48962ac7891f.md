# [Mappings](README.md): Claude - claude_organization_settings_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_organization_settings_updated`|
...
|action|type||
|changeType|None|The static text `Claude organization settings were updated` is populated in this schema field.|
...
|description|None|The static text `Claude organization settings were updated` is populated in this schema field.|
