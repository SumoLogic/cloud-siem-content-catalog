# [Mappings](README.md): Claude - org_data_export_started
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_data_export_started`|
...
|action|type||
|changeType|None|The static text `Organization data export was initiated` is populated in this schema field.|
...
|description|None|The static text `Organization data export was initiated` is populated in this schema field.|
