# [Mappings](README.md): Windows Defender SCCM DB CSV
...
|timestamp|timestamp|We expect the original record value of `timestamp` is in the format `MM/dd/yyyy HH:mm:ss aa`|
