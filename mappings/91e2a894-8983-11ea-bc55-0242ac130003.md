...
|timestamp|GenericEvent.ScannerSoftware.GenericEventInfo.GMTTime|We expect the original record value of `GenericEvent.ScannerSoftware.GenericEventInfo.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
