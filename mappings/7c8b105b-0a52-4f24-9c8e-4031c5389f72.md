# [Mappings](README.md): Jamf Audit User - Authentication
...
|timestamp|header.time_seconds_epoch|We expect the original record value of `header.time_seconds_epoch` is in the format `epoch`|
