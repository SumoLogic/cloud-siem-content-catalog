# [Mappings](README.md): CloudTrail - ec2.amazonaws.com - DeleteKeyPair
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteKeyPair`|
...
|description|None|The static text `A request was made to delete a key-pair from EC2.` is populated in this schema field.|
