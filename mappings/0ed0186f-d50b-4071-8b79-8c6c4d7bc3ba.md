# [Mappings](README.md): Claude - cli_plugin_exec_policy_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`cli_plugin_exec_policy_updated`|
...
|description|None|The static text `CLI plugin execution policy permission ceiling was updated` is populated in this schema field.|
