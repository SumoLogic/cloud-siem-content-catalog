# [Mappings](README.md): CloudTrail - iam.amazonaws.com - CreateAccessKey
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-CreateAccessKey`|
...
|description|None|The static text `A request to create an IAM access key was made` is populated in this schema field.|
