# [Mappings](README.md): CloudTrail - s3.amazonaws.com - PutBucketCors
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-PutBucketCors`|
...
|description|None|The static text `A request was made to delete a Cross-origin resource sharing (CORS) configuration from an S3 bucket configuration information set on an S3 bucket` is populated in this schema field.|
