# [Mappings](README.md): Claude - org_invite_link_disabled
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_invite_link_disabled`|
...
|action|type||
|changeType|None|The static text `Organization invite link was disabled` is populated in this schema field.|
...
|description|None|The static text `Organization invite link was disabled` is populated in this schema field.|
