# [Mappings](README.md): Claude - claude_skill_created
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_skill_created`|
...
|action|type||
|changeTarget|skill_id||
|changeType|None|The static text `Claude skill was created` is populated in this schema field.|
...
|description|None|The static text `Claude skill was created` is populated in this schema field.|
