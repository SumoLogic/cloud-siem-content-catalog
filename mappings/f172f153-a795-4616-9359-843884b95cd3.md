# [Mappings](README.md): Tanium IOC Event (Unknown) - CEF Custom Parser
...
|timestamp|Timestamp|We expect the original record value of `Timestamp` is in the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`|
