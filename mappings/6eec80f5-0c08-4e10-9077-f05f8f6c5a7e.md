# [Mappings](README.md): Claude - claude_chat_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_chat_deleted`|
...
|changeType|None|The static text `Claude chat conversation was deleted` is populated in this schema field.|
...
|description|None|The static text `Claude chat conversation was deleted` is populated in this schema field.|
