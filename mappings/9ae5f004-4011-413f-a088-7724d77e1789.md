# [Mappings](README.md): Proofpoint Targeted Attack Protection C2C - Click Blocked
...
|timestamp|clickTime|We expect the original record value of `clickTime` is in the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`|
