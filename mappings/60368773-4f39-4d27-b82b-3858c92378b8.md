# [Mappings](README.md): Claude - desktop_extension_blocklisted
...
|Log Format|JSON|
|Event ID Regex Pattern|`desktop_extension_blocklisted`|
...
|description|None|The static text `Desktop extension was added to global blocklist` is populated in this schema field.|
