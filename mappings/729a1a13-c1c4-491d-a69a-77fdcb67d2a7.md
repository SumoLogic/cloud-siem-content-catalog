# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DetachRolePolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DetachRolePolicy`|
...
|description|None|The static text `An IAM managed policy was removed from a IAM role.` is populated in this schema field.|
