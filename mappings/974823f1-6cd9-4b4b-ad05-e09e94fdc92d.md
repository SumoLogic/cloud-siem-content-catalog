# [Mappings](README.md): CloudTrail - s3.amazonaws.com - CreateBucket
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-CreateBucket`|
...
|description|None|The static text `A request was made to create an S3 bucket` is populated in this schema field.|
