# [Mappings](README.md): Symantec Agent Risk Logs
...
|timestamp|Event_Time|We expect the original record value of `Event_Time` is in the format `yyyy-MM-dd HH:mm:ss`|
