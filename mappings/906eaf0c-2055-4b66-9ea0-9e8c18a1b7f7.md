# [Mappings](README.md): Claude - claude_artifact_viewed
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_artifact_viewed`|
...
|action|type||
|changeType|None|The static text `Claude artifact was viewed` is populated in this schema field.|
...
|description|None|The static text `Claude artifact was viewed` is populated in this schema field.|
