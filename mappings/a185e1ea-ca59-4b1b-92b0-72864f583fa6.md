# [Mappings](README.md): Claude - claude_project_sharing_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_project_sharing_updated`|
...
|action|type||
|changeTarget|claude_project_id||
|changeType|None|The static text `Claude project sharing settings were updated` is populated in this schema field.|
...
|description|None|The static text `Claude project sharing settings were updated` is populated in this schema field.|
