# [Mappings](README.md): CloudTrail - sso.amazonaws.com - Federate
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsServiceEvent-Federate`|
...
|description|None|The static text `A user was federated into AWS with Single Sign-On` is populated in this schema field.|
