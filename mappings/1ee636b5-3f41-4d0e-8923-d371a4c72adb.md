# [Mappings](README.md): CloudTrail - lambda.amazonaws.com - GetPolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-GetPolicy`|
...
|description|None|The static text `Returns the resource-based IAM policy for a function, version, or alias.` is populated in this schema field.|
