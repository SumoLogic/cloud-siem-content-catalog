# [Mappings](README.md): Claude - user_logged_out
...
|Log Format|JSON|
|Event ID Regex Pattern|`user_logged_out`|
...
|action|type||
|changeType|None|The static text `User logged out` is populated in this schema field.|
...
|description|None|The static text `User logged out` is populated in this schema field.|
