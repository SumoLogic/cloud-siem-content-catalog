# [Mappings](README.md): Claude - org_member_invites_disabled
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_member_invites_disabled`|
...
|action|type||
|changeType|None|The static text `Organization member invitations were disabled` is populated in this schema field.|
...
|description|None|The static text `Organization member invitations were disabled` is populated in this schema field.|
