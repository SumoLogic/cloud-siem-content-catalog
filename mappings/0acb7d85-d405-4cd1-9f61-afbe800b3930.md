# [Mappings](README.md): CloudTrail - s3.amazonaws.com - DeleteBucketCors
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteBucketCors`|
...
|description|None|The static text `A request was made to delete a Cross-origin resource sharing (CORS) configuration from an S3 bucket` is populated in this schema field.|
