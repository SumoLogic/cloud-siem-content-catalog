# [Mappings](README.md): CloudTrail - iam.amazonaws.com - AttachRolePolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-AttachRolePolicy`|
...
|description|None|The static text `An IAM policy was attached to a IAM role.` is populated in this schema field.|
