# [Mappings](README.md): CloudTrail - s3.amazonaws.com - PutBucketAcl
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-PutBucketAcl`|
...
|description|None|The static text `A request was made to set permissions on an S3 bucket with an Access Control List` is populated in this schema field.|
