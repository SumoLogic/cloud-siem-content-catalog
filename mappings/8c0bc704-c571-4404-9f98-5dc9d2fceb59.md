# [Mappings](README.md): Claude - org_user_invite_sent
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_user_invite_sent`|
...
|action|type||
|changeType|None|The static text `Organization user invitation was sent` is populated in this schema field.|
...
|description|None|The static text `Organization user invitation was sent` is populated in this schema field.|
...
|targetUser_username|invited_email||
