# [Mappings](README.md): CloudTrail - ec2.amazonaws.com - DeleteInternetGateway
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteInternetGateway`|
...
|description|None|The static text `An attempt to delete an Internet Gateway was requested` is populated in this schema field.|
