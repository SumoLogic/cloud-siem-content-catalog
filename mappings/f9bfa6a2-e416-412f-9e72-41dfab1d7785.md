# [Mappings](README.md): Claude - org_sso_connection_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_sso_connection_deleted`|
...
|changeType|None|The static text `SSO connection was deleted` is populated in this schema field.|
...
|description|None|The static text `SSO connection was deleted` is populated in this schema field.|
