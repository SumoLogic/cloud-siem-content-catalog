# [Mappings](README.md): CloudTrail - lambda.amazonaws.com - Resource Access
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-(ListFunctionUrlConfigs\|GetFunctionConfiguration\|GetFunctionUrlConfig\|GetEventSourceMapping)`|
