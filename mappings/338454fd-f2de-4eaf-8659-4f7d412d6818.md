# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DeleteUser
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteUser`|
...
|description|None|The static text `A request was made to delete a AWS IAM user` is populated in this schema field.|
