# [Mappings](README.md): Claude - platform_api_key_created
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_api_key_created`|
...
|changeType|None|The static text `Platform API key was created` is populated in this schema field.|
...
|description|None|The static text `Platform API key was created` is populated in this schema field.|
