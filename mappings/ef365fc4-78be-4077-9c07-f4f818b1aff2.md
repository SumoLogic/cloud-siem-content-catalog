# [Mappings](README.md): CloudTrail - lambda.amazonaws.com - GetFunctionUrlConfig
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-GetFunctionUrlConfig`|
...
|description|None|The static text `Returns details about a Lambda function URL.` is populated in this schema field.|
