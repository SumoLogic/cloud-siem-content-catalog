# [Mappings](README.md): Claude - claude_chat_viewed
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_chat_viewed`|
...
|action|type||
|changeType|None|The static text `Claude chat conversation was viewed` is populated in this schema field.|
...
|description|None|The static text `Claude chat conversation was viewed` is populated in this schema field.|
