...
|timestamp|EPOevent.SoftwareInfo.CommonFields.GMTTime|We expect the original record value of `EPOevent.SoftwareInfo.CommonFields.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
