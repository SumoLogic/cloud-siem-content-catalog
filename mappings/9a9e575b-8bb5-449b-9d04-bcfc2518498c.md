# [Mappings](README.md): CloudTrail - s3.amazonaws.com - DeleteBucketLifecycle
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteBucketLifecycle`|
...
|description|None|The static text `A request was made to delete the lifecycle configuration from an S3 bucket` is populated in this schema field.|
