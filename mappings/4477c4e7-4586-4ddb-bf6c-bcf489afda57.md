# [Mappings](README.md): Claude - claude_code_review_repository_removed
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_code_review_repository_removed`|
...
|description|None|The static text `Repository was removed from Claude Code Review configuration` is populated in this schema field.|
