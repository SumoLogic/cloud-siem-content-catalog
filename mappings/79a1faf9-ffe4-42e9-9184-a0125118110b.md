# [Mappings](README.md): Claude - domain_claim_initiated
...
|Log Format|JSON|
|Event ID Regex Pattern|`domain_claim_initiated`|
...
|description|None|The static text `Domain capture claim initiated over personal accounts on verified domains` is populated in this schema field.|
