# [Mappings](README.md): Claude - mcp_server_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`mcp_server_updated`|
...
|action|type||
|changeTarget|mcp_server_id||
|changeType|None|The static text `MCP server configuration was updated` is populated in this schema field.|
...
|description|None|The static text `MCP server configuration was updated` is populated in this schema field.|
