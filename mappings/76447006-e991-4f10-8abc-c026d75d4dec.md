# [Mappings](README.md): Claude - platform_federation_rule_workspace_added
...
|Log Format|JSON|
|Event ID Regex Pattern|`platform_federation_rule_workspace_added`|
...
|description|None|The static text `Federation rule was enabled for a workspace` is populated in this schema field.|
