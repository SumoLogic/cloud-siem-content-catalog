# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DetachGroupPolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DetachGroupPolicy`|
...
|description|None|The static text `An IAM managed policy was removed from a IAM group.` is populated in this schema field.|
