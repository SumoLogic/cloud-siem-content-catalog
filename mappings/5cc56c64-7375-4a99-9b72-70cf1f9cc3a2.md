# [Mappings](README.md): McAfee Endpoint EE Event Logs
...
|timestamp|EE_Event.EventData.EventNode.GMTTime|We expect the original record value of `EE_Event.EventData.EventNode.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
