# [Mappings](README.md): CloudTrail - ec2.amazonaws.com - DeleteNetworkAcl
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteNetworkAcl`|
...
|description|None|The static text `A network access control list was deleted in a VPC` is populated in this schema field.|
