# [Mappings](README.md): Claude - org_ip_restriction_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_ip_restriction_updated`|
...
|description|None|The static text `IP restriction was updated` is populated in this schema field.|
