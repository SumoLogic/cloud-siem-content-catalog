# [Mappings](README.md): Claude - claude_code_review_config_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_code_review_config_updated`|
...
|description|None|The static text `Claude Code Review configuration was updated` is populated in this schema field.|
