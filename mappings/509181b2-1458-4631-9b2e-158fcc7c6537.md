# [Mappings](README.md): Claude - claude_project_created
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_project_created`|
...
|changeType|None|The static text `Claude project was created` is populated in this schema field.|
...
|description|None|The static text `Claude project was created` is populated in this schema field.|
