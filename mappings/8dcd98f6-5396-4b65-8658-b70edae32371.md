# [Mappings](README.md): CloudTrail - iam.amazonaws.com - DeleteRolePolicy
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteRolePolicy`|
...
|description|None|The static text `An IAM inline policy that is embedded in the specified IAM role was deleted.` is populated in this schema field.|
