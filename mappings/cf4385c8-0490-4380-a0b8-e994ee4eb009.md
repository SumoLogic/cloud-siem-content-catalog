# [Mappings](README.md): Claude - mcp_server_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`mcp_server_deleted`|
...
|changeType|None|The static text `MCP server was deleted` is populated in this schema field.|
...
|description|None|The static text `MCP server was deleted` is populated in this schema field.|
