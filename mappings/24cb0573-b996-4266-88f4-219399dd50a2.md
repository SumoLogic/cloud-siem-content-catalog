# [Mappings](README.md): Claude - claude_file_viewed
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_file_viewed`|
...
|action|type||
|changeType|None|The static text `File in Claude was viewed` is populated in this schema field.|
...
|description|None|The static text `File in Claude was viewed` is populated in this schema field.|
