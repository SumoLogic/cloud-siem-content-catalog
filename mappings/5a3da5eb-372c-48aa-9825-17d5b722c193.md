# [Mappings](README.md): CloudTrail - ec2.amazonaws.com - CreateKeyPair
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-CreateKeyPair`|
...
|description|None|The static text `A request was made to create a key-pair in EC2.` is populated in this schema field.|
