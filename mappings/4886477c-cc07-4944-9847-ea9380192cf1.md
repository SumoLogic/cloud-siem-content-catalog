# [Mappings](README.md): Proofpoint Targeted Attack Protection C2C - Message Permitted
...
|timestamp|messageTime|We expect the original record value of `messageTime` is in the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`|
