# [Mappings](README.md): Claude - claude_code_security_center_config_updated
...
|Log Format|JSON|
|Event ID Regex Pattern|`claude_code_security_center_config_updated`|
...
|description|None|The static text `Claude Code Security Center scanning configuration was updated` is populated in this schema field.|
