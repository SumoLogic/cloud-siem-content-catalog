...
|timestamp|VSAS120PerformanceEvent.ScannerSoftware.VSASPerformanceEventInfo.GMTTime|We expect the original record value of `VSAS120PerformanceEvent.ScannerSoftware.VSASPerformanceEventInfo.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
