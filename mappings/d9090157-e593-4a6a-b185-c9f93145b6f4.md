# [Mappings](README.md): CloudTrail - kms.amazonaws.com - ScheduleKeyDeletion
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-ScheduleKeyDeletion`|
...
|description|None|The static text `A customer master key (CMK) was scheduled for deletion.` is populated in this schema field.|
