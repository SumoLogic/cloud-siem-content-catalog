# [Mappings](README.md): Claude - org_ip_restriction_created
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_ip_restriction_created`|
...
|changeType|None|The static text `IP restriction was created` is populated in this schema field.|
...
|description|None|The static text `IP restriction was created` is populated in this schema field.|
