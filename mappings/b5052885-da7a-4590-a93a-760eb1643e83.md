# [Mappings](README.md): Claude - desktop_extension_deleted
...
|Log Format|JSON|
|Event ID Regex Pattern|`desktop_extension_deleted`|
...
|description|None|The static text `Desktop extension was deleted from organization or global scope` is populated in this schema field.|
