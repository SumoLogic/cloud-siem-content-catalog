...
|timestamp|PortBlockEvent.ScannerSoftware.BlockedPortInfo.GMTTime|We expect the original record value of `PortBlockEvent.ScannerSoftware.BlockedPortInfo.GMTTime` is in the format `YYYY-MM-dd'T'HH:mm:ss`|
