# [Mappings](README.md): Claude - org_invite_link_generated
...
|Log Format|JSON|
|Event ID Regex Pattern|`org_invite_link_generated`|
...
|action|type||
|changeType|None|The static text `Organization invite link was generated` is populated in this schema field.|
...
|description|None|The static text `Organization invite link was generated` is populated in this schema field.|
