# [Mappings](README.md): CloudTrail - cloudtrail.amazonaws.com - DeleteTrail
...
|Product|CloudTrail|
|Log Format|JSON|
|Event ID Regex Pattern|`AwsApiCall-DeleteTrail`|
...
|description|None|The static text `An attempt to delete a Trail in CloudTrail was requested` is populated in this schema field.|
