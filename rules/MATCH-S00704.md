# [Rules](README.md): Persistence Registry Key Modification
...
|Signal Name|Persistence Registry Key Modification - {{file_path}}|
|Summary Expression|Persistence registry key {{file_path}} modification detected on host: {{device_hostname}}|
