# [Rules](README.md): Malicious Service Installs
...
|Signal Name|Malicious Service Installs|
|Summary Expression|Malicious service installation detected on {{device_hostname}}|
