# [Rules](README.md): Kubernetes ListSecrets
...
|Signal Name|Kubernetes ListSecrets|
|Summary Expression|User: {{user_username}} ran a command to get secrets using kubectl|
