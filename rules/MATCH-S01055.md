# [Rules](README.md): OCSF Vulnerability Finding
...
|Signal Name|OCSF Vulnerability Finding: {{threat_signalName}}|
|Summary Expression|Unresolved Vulnerability  Finding on {{resource}} ({{resourceType}}) . {{threat_signalSummary}}|
