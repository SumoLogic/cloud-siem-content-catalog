# [Rules](README.md): Network Connection from Regsvcs/Regasm - Sysmon
...
|Signal Name|Network Connection from Regsvcs/Regasm - Sysmon|
|Summary Expression|{{file_path}} made a network connection on host: {{srcDevice_hostname}}|
|Score/Severity|Static: 3|
|Enabled by Default|True|
|Prototype|False|
|Tags|_mitreAttackTactic:TA0005, _mitreAttackTechnique:T1218, _mitreAttackTechnique:T1218.009|
