# [Rules](README.md): Threat Intel - HTTP Hostname
...
|Signal Name|Threat Intel - HTTP Hostname|
|Summary Expression|Threat Intel - HTTP Hostname detected for: {{http_hostname}}|
