# [Rules](README.md): SSL Certificate Not Valid Yet
...
|Signal Name|SSL Certificate Not Valid Yet|
|Summary Expression|Server responded with SSL or TLS certificate that is not yet valid from IP: {{srcDevice_ip}}|
