# [Rules](README.md): Network Connection from Rundll32 - Sysmon
...
|Signal Name|Network Connection from Rundll32 - Sysmon|
|Summary Expression|Rundll32.exe made a network connection on host: {{srcDevice_hostname}}|
