...
## Description
Passes through a data-protection, email, deception, or application security detection (e.g. DLP, Proofpoint, Thinkst Canary, Contrast) and adjusts the severity accordingly based on the severity provided in the log.
