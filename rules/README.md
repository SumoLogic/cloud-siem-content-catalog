...
|[threat_rules.csv](threat_rules.csv)|Each [normalized threat rule](https://help.sumologic.com/Cloud_SIEM_Enterprise/CSE_Schema/Field_Mapping_for_Security_Event_Sources) and its associated mappings using the `threat_ruleType` schema field.|
|[auth_rules.csv](auth_rules.csv)|Each [normalized authentication rule](https://help.sumologic.com/Cloud_SIEM_Enterprise/CSE_Rules/Normalized_Authentication_Rules) and its associated mappings using the `normalizedAction` schema field.|
