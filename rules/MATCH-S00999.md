# [Rules](README.md): Threat Intel - IMPHASH Match

## Description
This rule detects an IMPHASH indicator match from a threat intelligence feed
...
|Summary Expression|The record contains a matching IMPHASH from a threat intelligence feed: {{file_hash_imphash}}|
