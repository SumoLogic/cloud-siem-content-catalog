# [Rules](README.md): Salesforce Permission Set Addition
...
|Signal Name|Salesforce Permission Set Addition|
|Summary Expression|Salesforce Permission Set Addition: {{description}} User: {{user_username}} IP: {{srcDevice_ip}}|
