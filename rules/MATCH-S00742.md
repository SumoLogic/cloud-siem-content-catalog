# [Rules](README.md): Network Connection from Regsvr32 - Sysmon
...
|Signal Name|Network Connection from Regsvr32 - Sysmon|
|Summary Expression|Regsvr32.exe made a network connection on host: {{srcDevice_hostname}}|
